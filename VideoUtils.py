...
def VideoIterator(video_fname, interval=1, start=0):
...
def get_all_frames(num_frames, video_fname, interval=1, start=0, dtype='float32'):
    ...
    vid_it = VideoIterator(video_fname, interval=interval, start=start)
